...
import { womensDetails } from './productDetails'
...
export default function Womens() {
    ...
    const [isCurrentState, setIsCurrentState] = useState(womensDetails)
        ...
        <>
            <div className={Styles.section_1}>
                <div className={Styles.breadCrum}>
                    <p><Link to='/' style={{ textDecoration: "none", color: "#000" }}>Home</Link> / Clothing / <span>Women's Fashion</span></p>
                </div>
            </div>
